...
_Unfold (&nbsp;&blacktriangleright;&nbsp;) for short, specific examples._
...
- Secure private network:
  ...
  - Strict reciprocal security group
    ...
    rules permit traffic only between identified hosts, not within entire private IP&nbsp;address blocks
- [Data-driven](https://github.com/sqlxpert/lights-off-aws/blob/dfe86f7/terraform-multi/variables.tf#L16-L24),
  not hard-coded,
  [validation and error](https://github.com/sqlxpert/lights-off-aws/blob/dfe86f7/terraform-multi/variables.tf#L33-L40)
...
- Same template for individual stacks or a centrally-managed, multi-account, multi-region Stack**Set**:
  - ["Partial ARN" parameters](https://github.com/sqlxpert/lights-off-aws/blob/8fb1e8c/cloudformation/lights_off_aws.yaml#L302-L315)
    are
    [not region-specific](https://github.com/sqlxpert/lights-off-aws/blob/8fb1e8c/cloudformation/lights_off_aws.yaml#L1000-L1003)
...
- [Typed, structured JSON log entries](https://github.com/sqlxpert/lights-off-aws/blob/c86306c/python/lights_off_aws.py#L63-L98),
